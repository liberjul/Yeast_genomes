...
#SBATCH --job-name OrthoANI_self          # you can give your job a name for easier identification (same as -J)
...
#  -fasta1 $DATADIR/assembly/Aimania_JL201.fsa > $DATADIR/ani/JL201-JL201_orthoani.txt
java -jar ~/bin/OAT_cmd.jar -blastplus_dir $BLASTDIR \
  -fasta2 $DATADIR/assembly/Aimania_JL221.fsa \
  -fasta1 $DATADIR/assembly/Aimania_JL221.fsa > $DATADIR/ani/JL221-JL221_orthoani.txt
#java -jar ~/bin/OAT_cmd.jar -blastplus_dir $BLASTDIR \
#  -fasta2 $DATADIR/assembly/Aimania_NB124.fsa \
#  -fasta1 $DATADIR/assembly/Aimania_NB124.fsa > $DATADIR/ani/NB124-NB124_orthoani.txt
