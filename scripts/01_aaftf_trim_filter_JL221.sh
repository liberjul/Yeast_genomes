...
#SBATCH --job-name=trim_filter_reads_JL221        # you can give your job a name for easier identification (same as -J)
...
MEM=16 # 16gb
CPU=8
FWD=../data/raw_data/JL221_S55_R1_001.fastq.gz
REV=../data/raw_data/JL221_S55_R2_001.fastq.gz
BASE=JL221_S55
