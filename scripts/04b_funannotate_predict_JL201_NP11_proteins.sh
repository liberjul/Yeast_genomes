...
~/bin/gmes_linux_64/gmes_petap.pl --ES --max_intron 3000 --soft_mask 2000 --cores 16 \
  --sequence $DATADIR/assembly/JL201/scaffolds.masked.fasta --fungus

mv genemark.gtf $DATADIR/annotation/JL201
mv gmhmm.mod $DATADIR/annotation/JL201
mv run.cfg $DATADIR/annotation/JL201
...
funannotate predict -i $DATADIR/assembly/JL201/scaffolds.masked.fasta \
  ...
  --genemark_gtf $DATADIR/annotation/JL201/genemark.gtf \
  --cpus 16
