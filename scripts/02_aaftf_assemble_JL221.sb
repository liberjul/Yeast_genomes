...
#SBATCH --job-name=assemble_JL221        # you can give your job a name for easier identification (same as -J)
...
CPU=24
MEM=64
FWD=../data/filt_trimmed/JL221_S55_1P.fastq.gz
REV=../data/filt_trimmed/JL221_S55_2P.fastq.gz
