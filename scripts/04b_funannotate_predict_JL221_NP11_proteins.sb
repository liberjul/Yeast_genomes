...
#SBATCH --job-name=funannotate_predict_JL221_NP11_prot        # you can give your job a name for easier identification (same as -J)
...
~/bin/gmes_linux_64/gmes_petap.pl --ES --max_intron 3000 --soft_mask 2000 --cores 16 \
  --sequence $DATADIR/assembly/JL221/scaffolds.masked.fasta --fungus

mv genemark.gtf $DATADIR/annotation/JL221
mv gmhmm.mod $DATADIR/annotation/JL221
mv run.cfg $DATADIR/annotation/JL221

funannotate predict -i $DATADIR/assembly/JL221/scaffolds.masked.fasta \
  -o $DATADIR/annotation/JL221 \
  -s "Microbotryomycetes sp" --strain JL221 \
  --protein_evidence $DATADIR/annotation/Rhoto1_GeneCatalog_proteins_20141208.aa.fasta \
  --busco_db basidiomycota \
  --genemark_gtf $DATADIR/annotation/JL221/genemark.gtf \
  --cpus 16
